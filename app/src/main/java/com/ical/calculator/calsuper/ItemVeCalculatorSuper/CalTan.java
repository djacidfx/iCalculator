...
public class CalTan extends PerUnaryOperation implements OperationSuperCalculator {
    public CalTan(double value) {
        super(value);
    }
    ...
    public double getResultCal() {
        ...
        return Math.tan((this.value * 3.141592653589793d) / 180.0d);
    }
}
